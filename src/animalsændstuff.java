...
public class animalsændstuff {
	public static void main(String[] args) throws MalformedURLException {
		 ...
		 */
		animalsændstuff zargonite = new animalsændstuff();
		zargonite.tripshot();

	}

	String urlOfAnimalSuckingAtJumping = "http://65.media.tumblr.com/8d95d7e99cd36bc0ac0527015bf46cd3/tumblr_n3qw9kgGSz1syxxpeo7_400.gif";

	void tripshot() throws MalformedURLException {
		JFrame denied = new JFrame();
		denied.setLocationRelativeTo(null);
		denied.setTitle("Cat Versus Foil: Denied Edition");
		JLabel spaceball = createImage(urlOfAnimalSuckingAtJumping);
		denied.add(spaceball);
		denied.pack();
