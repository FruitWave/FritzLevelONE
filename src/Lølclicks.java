...
haha.pack();
haha.show();
String bubbleInfinity = JOptionPane.showInputDialog("The number of daleks evades Fritz's knowledge. Only you can use this technology specially designed for you to discover the truth. Ex-ex-ex-ex-OH NO-EXTERMINATE!!! Quickly! Enter a number exceeding a hundred!!!");
