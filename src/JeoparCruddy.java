...
frame.add(quizPanel);
	...
	firstButton = this.createButton("$∂ßƒøπΩΩΩΩ≈≈ççç√∫˜∫∫∫∫µµ`¬`∫µ");

	// 7. Add the firstButton to the quizPanel
		quizPanel.add(firstButton);
		// 8. Write the code inside the createButton() method below. Check that your game looks like Figure 1 in the JeoparCruddy Handout - http://bit.ly/1bvnvd4.
